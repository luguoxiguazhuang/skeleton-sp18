...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        for (int i = 0; i < n; i += 1) {
            result += Character.toString(CHARACTERS[rand.nextInt(0,CHARACTERS.length)]);
        }
        return result;
    }
    ...
    public void flashSequence(String letters) {
        ...
        for (int i = 0; i < letters.length(); i += 1) {
            String newstring = Character.toString(letters.charAt(i));
            drawFrame(newstring);
            StdDraw.pause(500);
            drawFrame("");
            StdDraw.pause(500);
    ...
    public String solicitNCharsInput(int n) {
        ...
        while (result.length() < n) {
            if (!StdDraw.hasNextKeyTyped()) {
                ...
                char newCharacter =  StdDraw.nextKeyTyped();
