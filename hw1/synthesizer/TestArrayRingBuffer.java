...
public class TestArrayRingBuffer {
    ...
    public void someTest() {
        ...
        arb.enqueue(1.2);
        //arb.enqueue(1.2);
        //assertEquals(9.3,arb.peek());
        // 15.1 31.2  -3.1       (returns 9.3)
        assertEquals(15.1, arb.dequeue());// 15.1 31.2  -3.1       (returns 9.3)
        assertEquals(31.2, arb.dequeue());// 15.1 31.2  -3.1       (returns 9.3)
        assertEquals(-3.1, arb.dequeue());// 15.1 31.2  -3.1       (returns 9.3)
        assertEquals(1.2,arb.dequeue());
